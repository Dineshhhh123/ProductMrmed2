...
const Product=require('../databases/model');
const fs=require("fs");
...
Product.findById(req.body.productName, (err, data) => {
    ...
    const product = new Product({
        ...
        dossageForm:req.body.dossageForm,
...
exports.download = (req, res) => {
    ...
    Product.find({}).then((objs) => {
        ...
        worksheet.columns = [
          ...
          { header: "dossageForm", key: "dossageForm", width: 25 },
